...
async function exportAnamnesisToPDF(client, record) {
    ...
    doc.text(`Data: ${record.date.toDate().toLocaleDateString('pt-BR')}`, 15, 30);
    ...
    doc.setFont("helvetica", "normal");
    doc.text(`Nome: ${client.name}`, 15, 50);
    doc.text(`Telefone: ${client.phone}`, 15, 57);

    doc.line(15, 65, 195, 65);

    doc.setFont("helvetica", "bold");
    doc.text('Questionário', 15, 73);
    doc.setFont("helvetica", "normal");
